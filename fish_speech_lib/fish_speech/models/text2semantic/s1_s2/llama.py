...
from fish_speech_lib.fish_speech.models.text2semantic.lora import LoraConfig, setup_lora
...
class BaseTransformer(nn.Module):
    ...
    def from_pretrained(
        ...
        from fish_speech_lib.fish_speech.s1_s2.tokenizer import FishTokenizer
