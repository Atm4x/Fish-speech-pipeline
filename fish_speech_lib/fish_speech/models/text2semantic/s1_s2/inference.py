...
from fish_speech_lib.fish_speech.content_sequence import TextPart, VQPart
from fish_speech_lib.fish_speech.s1_s2.conversation import Conversation, Message
from fish_speech_lib.fish_speech.s1_s2.tokenizer import IM_END_TOKEN
...
from fish_speech_lib.fish_speech.models.text2semantic.s1_s2.llama import (
    BaseTransformer,
    DualARTransformer,
    NaiveTransformer,
)
...
def load_codec_model(codec_checkpoint_path, device, precision=torch.bfloat16):
    """Load the DAC codec model for audio encoding/decoding without Hydra."""
    from fish_speech_lib.fish_speech.models.dac.inference import load_model as load_dac
    
    codec = load_dac(config_name=None, checkpoint_path=codec_checkpoint_path, device=device)
