...
from fish_speech_lib.fish_speech.content_sequence import (
    AudioPart,
    BasePart,
    ContentSequence,
    EncodedMessage,
...
from fish_speech_lib.fish_speech.s1_s2.tokenizer import IM_END_TOKEN, IM_START_TOKEN, MODALITY_TOKENS
